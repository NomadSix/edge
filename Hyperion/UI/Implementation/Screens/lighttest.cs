...
namespace Edge.Hyperion.UI.Implementation.Screens {
    ...
    public class Game1 : Screen {
        ...
        private void BuildObjectList() {
            ...
            objects[0] = new ConvexHull(that, points, wallColor, Vector2.Zero);
            objects[1] = new ConvexHull(that, points, wallColor, new Vector2(0, 580));
            ...
            objects[2] = new ConvexHull(that, points, wallColor, Vector2.Zero);
            objects[3] = new ConvexHull(that, points, wallColor, new Vector2(780, 0));
            ...
            objects[4] = new ConvexHull(that, points, wallColor, new Vector2(20, 140));
            objects[5] = new ConvexHull(that, points, wallColor, new Vector2(20, 440));
            ...
            objects[6] = new ConvexHull(that, points, wallColor, new Vector2(580, 140));
            objects[7] = new ConvexHull(that, points, wallColor, new Vector2(580, 320));
            ...
            objects[8] = new ConvexHull(that, points, wallColor, new Vector2(640, 140));
            objects[9] = new ConvexHull(that, points, wallColor, new Vector2(640, 240));
            objects[10] = new ConvexHull(that, points, wallColor, new Vector2(640, 340));
            objects[11] = new ConvexHull(that, points, wallColor, new Vector2(640, 440));

            objects[12] = new ConvexHull(that, points, wallColor, new Vector2(720, 140));
            objects[13] = new ConvexHull(that, points, wallColor, new Vector2(720, 240));
            objects[14] = new ConvexHull(that, points, wallColor, new Vector2(720, 340));
            objects[15] = new ConvexHull(that, points, wallColor, new Vector2(720, 440));
            ...
            objects[16] = new ConvexHull(that, points, wallColor, new Vector2(100, 500));

            objects[17] = new ConvexHull(that, points, wallColor, new Vector2(200, 460));

            objects[18] = new ConvexHull(that, points, wallColor, new Vector2(300, 500));
            objects[19] = new ConvexHull(that, points, wallColor, new Vector2(400, 460));

            objects[20] = new ConvexHull(that, points, wallColor, new Vector2(500, 500));
            objects[21] = new ConvexHull(that, points, wallColor, new Vector2(580, 460));
            ...
            objects[22] = new ConvexHull(that, points, wallColor, new Vector2(160, 280));
            objects[23] = new ConvexHull(that, points, wallColor, new Vector2(360, 280));
            ...
            objects[24] = new ConvexHull(that, points, wallColor, new Vector2(460, 80));
            objects[25] = new ConvexHull(that, points, wallColor, new Vector2(560, 80));
            objects[26] = new ConvexHull(that, points, wallColor, new Vector2(160, 80));
            ...
            objects[27] = new ConvexHull(that, points, wallColor, new Vector2(140, 220));
            objects[28] = new ConvexHull(that, points, wallColor, new Vector2(240, 220));
            objects[29] = new ConvexHull(that, points, wallColor, new Vector2(340, 220));
            objects[30] = new ConvexHull(that, points, wallColor, new Vector2(440, 220));

            objects[31] = new ConvexHull(that, points, wallColor, new Vector2(140, 380));
            objects[32] = new ConvexHull(that, points, wallColor, new Vector2(240, 380));
            objects[33] = new ConvexHull(that, points, wallColor, new Vector2(340, 380));
            objects[34] = new ConvexHull(that, points, wallColor, new Vector2(440, 380));

            objects[35] = new ConvexHull(that, points, wallColor, new Vector2(80, 300));
            objects[36] = new ConvexHull(that, points, wallColor, new Vector2(500, 300));
        }

        public Game1(Game game) : base(game) {
        }
        ...
        protected override void LoadContent() {
            ...
            BuildObjectList();
            playerTexture = that.Content.Load<Texture2D>(@"..\UI\Implementation\Screens\ligh\WizardSquare");
            playerPosition = new Vector2(100, 100);

            tileTexture = that.Content.Load<Texture2D>(@"..\UI\Implementation\Screens\ligh\tile");
            ...
            alphaClearTexture = that.Content.Load<Texture2D>(@"..\UI\Implementation\Screens\ligh\AlphaOne");
